...
const INITIAL_OUTLETS: Outlet[] = [
  ...
  { id: 'sec88', name: 'Sec 88 Outlet', location: 'Sector 88', stock: {
    ...
    'sv-1': { productId: 'sv-1', openingStock: 1, received: 0, sold: 0, returned: 0, closingStock: 1, lastUpdated: new Date().toISOString() },
    'co-4': { productId: 'co-4', openingStock: 2, received: 0, sold: 0, returned: 0, closingStock: 2, lastUpdated: new Date().toISOString() },
    'ps-12': { productId: 'ps-12', openingStock: 4, received: 0, sold: 0, returned: 0, closingStock: 4, lastUpdated: new Date().toISOString() },
    'it-5': { productId: 'it-5', openingStock: 6, received: 0, sold: 0, returned: 0, closingStock: 6, lastUpdated: new Date().toISOString() },
    'co-17': { productId: 'co-17', openingStock: 3, received: 0, sold: 0, returned: 0, closingStock: 3, lastUpdated: new Date().toISOString() },
    ...
    'it-17': { productId: 'it-17', openingStock: 16, received: 0, sold: 0, returned: 0, closingStock: 16, lastUpdated: new Date().toISOString() },
    'ck-4': { productId: 'ck-4', openingStock: 0, received: 0, sold: 0, returned: 0, closingStock: 0, lastUpdated: new Date().toISOString() },
    'ps-2': { productId: 'ps-2', openingStock: 3, received: 4, sold: 3, returned: 0, closingStock: 4, lastUpdated: new Date().toISOString() },
    'ck-8': { productId: 'ck-8', openingStock: 0, received: 1, sold: 0, returned: 0, closingStock: 1, lastUpdated: new Date().toISOString() },
    'ps-7': { productId: 'ps-7', openingStock: 3, received: 0, sold: 0, returned: 0, closingStock: 3, lastUpdated: new Date().toISOString() },
    'ps-5': { productId: 'ps-5', openingStock: 1, received: 2, sold: 1, returned: 0, closingStock: 2, lastUpdated: new Date().toISOString() },
    'ot-1': { productId: 'ot-1', openingStock: 8, received: 0, sold: 0, returned: 0, closingStock: 8, lastUpdated: new Date().toISOString() },
    'br-1': { productId: 'br-1', openingStock: 1, received: 0, sold: 0, returned: 0, closingStock: 1, lastUpdated: new Date().toISOString() },
    'ck-6': { productId: 'ck-6', openingStock: 1, received: 1, sold: 1, returned: 0, closingStock: 1, lastUpdated: new Date().toISOString() },
    ...
    'sn-6': { productId: 'sn-6', openingStock: 2, received: 0, sold: 0, returned: 0, closingStock: 2, lastUpdated: new Date().toISOString() },
    'sn-7': { productId: 'sn-7', openingStock: 4, received: 0, sold: 0, returned: 0, closingStock: 4, lastUpdated: new Date().toISOString() },
    'sn-2': { productId: 'sn-2', openingStock: 10, received: 0, sold: 0, returned: 0, closingStock: 10, lastUpdated: new Date().toISOString() },
    'ot-7': { productId: 'ot-7', openingStock: 4, received: 0, sold: 0, returned: 0, closingStock: 4, lastUpdated: new Date().toISOString() },
    'ch-6': { productId: 'ch-6', openingStock: 1, received: 0, sold: 0, returned: 0, closingStock: 1, lastUpdated: new Date().toISOString() },
    'br-2': { productId: 'br-2', openingStock: 2, received: 0, sold: 0, returned: 0, closingStock: 2, lastUpdated: new Date().toISOString() },
    'ot-4': { productId: 'ot-4', openingStock: 4, received: 0, sold: 0, returned: 0, closingStock: 4, lastUpdated: new Date().toISOString() },
    'ch-4': { productId: 'ch-4', openingStock: 12, received: 0, sold: 0, returned: 0, closingStock: 12, lastUpdated: new Date().toISOString() },
    'ck1-5': { productId: 'ck1-5', openingStock: 0, received: 1, sold: 0, returned: 0, closingStock: 1, lastUpdated: new Date().toISOString() },
    'ck-5': { productId: 'ck-5', openingStock: 1, received: 0, sold: 0, returned: 0, closingStock: 1, lastUpdated: new Date().toISOString() },
    'ps-3': { productId: 'ps-3', openingStock: 0, received: 1, sold: 0, returned: 0, closingStock: 1, lastUpdated: new Date().toISOString() },
    'ck-2': { productId: 'ck-2', openingStock: 0, received: 1, sold: 0, returned: 0, closingStock: 1, lastUpdated: new Date().toISOString() },
    'ps-1': { productId: 'ps-1', openingStock: 4, received: 4, sold: 4, returned: 0, closingStock: 4, lastUpdated: new Date().toISOString() },
    'sn-5': { productId: 'sn-5', openingStock: 4, received: 0, sold: 0, returned: 0, closingStock: 4, lastUpdated: new Date().toISOString() },
    'bv-9': { productId: 'bv-9', openingStock: 1, received: 0, sold: 0, returned: 0, closingStock: 1, lastUpdated: new Date().toISOString() },
    'bv-6': { productId: 'bv-6', openingStock: 9, received: 0, sold: 0, returned: 0, closingStock: 9, lastUpdated: new Date().toISOString() },
    'ot-2': { productId: 'ot-2', openingStock: 6, received: 5, sold: 6, returned: 0, closingStock: 5, lastUpdated: new Date().toISOString() },
    ...
    'ot-3': { productId: 'ot-3', openingStock: 4, received: 0, sold: 0, returned: 0, closingStock: 4, lastUpdated: new Date().toISOString() },
    'ch-2': { productId: 'ch-2', openingStock: 27, received: 0, sold: 0, returned: 0, closingStock: 27, lastUpdated: new Date().toISOString() },
    ...
    'it-3': { productId: 'it-3', openingStock: 53, received: 0, sold: 0, returned: 0, closingStock: 53, lastUpdated: new Date().toISOString() },
    'co-1': { productId: 'co-1', openingStock: 2, received: 0, sold: 0, returned: 0, closingStock: 2, lastUpdated: new Date().toISOString() },
    ...
    'co-14': { productId: 'co-14', openingStock: 3, received: 0, sold: 0, returned: 0, closingStock: 3, lastUpdated: new Date().toISOString() },
    'bv-5': { productId: 'bv-5', openingStock: 11, received: 0, sold: 0, returned: 0, closingStock: 11, lastUpdated: new Date().toISOString() },
    'it-4': { productId: 'it-4', openingStock: 4, received: 0, sold: 0, returned: 0, closingStock: 4, lastUpdated: new Date().toISOString() },
    'br-8': { productId: 'br-8', openingStock: 1, received: 0, sold: 1, returned: 0, closingStock: 0, lastUpdated: new Date().toISOString() },
    'it-6': { productId: 'it-6', openingStock: 5, received: 0, sold: 0, returned: 0, closingStock: 5, lastUpdated: new Date().toISOString() },
    'ps-8': { productId: 'ps-8', openingStock: 3, received: 0, sold: 0, returned: 0, closingStock: 3, lastUpdated: new Date().toISOString() },
    'ot-6': { productId: 'ot-6', openingStock: 4, received: 0, sold: 0, returned: 0, closingStock: 4, lastUpdated: new Date().toISOString() },
    'co-6': { productId: 'co-6', openingStock: 4, received: 0, sold: 0, returned: 0, closingStock: 4, lastUpdated: new Date().toISOString() },
    'sv-2': { productId: 'sv-2', openingStock: 1, received: 0, sold: 0, returned: 0, closingStock: 1, lastUpdated: new Date().toISOString() },
    'it-15': { productId: 'it-15', openingStock: 2, received: 0, sold: 0, returned: 0, closingStock: 2, lastUpdated: new Date().toISOString() },
    'it-14': { productId: 'it-14', openingStock: 4, received: 0, sold: 0, returned: 0, closingStock: 4, lastUpdated: new Date().toISOString() },
    'sn-3': { productId: 'sn-3', openingStock: 4, received: 0, sold: 0, returned: 0, closingStock: 4, lastUpdated: new Date().toISOString() },
    'sn-4': { productId: 'sn-4', openingStock: 3, received: 0, sold: 0, returned: 0, closingStock: 3, lastUpdated: new Date().toISOString() },
    'ps-6': { productId: 'ps-6', openingStock: 2, received: 4, sold: 2, returned: 0, closingStock: 4, lastUpdated: new Date().toISOString() },
    'ck-9': { productId: 'ck-9', openingStock: 0, received: 1, sold: 0, returned: 0, closingStock: 1, lastUpdated: new Date().toISOString() },
    'co-5': { productId: 'co-5', openingStock: 3, received: 0, sold: 0, returned: 0, closingStock: 3, lastUpdated: new Date().toISOString() },
    'ps-4': { productId: 'ps-4', openingStock: 2, received: 2, sold: 2, returned: 0, closingStock: 2, lastUpdated: new Date().toISOString() },
    ...
    'it-1': { productId: 'it-1', openingStock: 4, received: 0, sold: 0, returned: 0, closingStock: 4, lastUpdated: new Date().toISOString() },
    'bv-8': { productId: 'bv-8', openingStock: 5, received: 0, sold: 0, returned: 0, closingStock: 5, lastUpdated: new Date().toISOString() },
    'bv-3': { productId: 'bv-3', openingStock: 3, received: 0, sold: 0, returned: 0, closingStock: 3, lastUpdated: new Date().toISOString() },
    'it-13': { productId: 'it-13', openingStock: 8, received: 0, sold: 0, returned: 0, closingStock: 8, lastUpdated: new Date().toISOString() },
    'ck-1': { productId: 'ck-1', openingStock: 1, received: 1, sold: 0, returned: 0, closingStock: 2, lastUpdated: new Date().toISOString() },
    'bv-2': { productId: 'bv-2', openingStock: 2, received: 0, sold: 0, returned: 0, closingStock: 2, lastUpdated: new Date().toISOString() },
  } }
];
...
export default function App() {
  ...
  return (
    <div className="flex bg-bakery-warm min-h-screen selection:bg-bakery-accent/30 tracking-tight">
      ...
      <main className="flex-1 lg:ml-56 p-4 md:p-6 transition-all duration-300">
